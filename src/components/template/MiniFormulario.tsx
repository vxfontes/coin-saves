...
interface MiniFormularioProps extends ChildrenProps {
    titulo: string
    descricao: string
    msgRodape: string
    podeSalvar: boolean
    ...
    return (
        ...
        `}>
            ...
            `}>
                ...
                {/* verifica condição do formulario e não deixa a função salvar ser executada caso não atenda as condições */}
                <Button
