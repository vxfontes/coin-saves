...
export default function CampoMesAno(props: CampoMesAnoProps) {
    ...
    return (
        <div className="flex items-center gap-2">
            <Button className={`
                flex justify-center items-center bg-indigo-600
                text-white cursor-pointer p-1
            `} color="indigo" onClick={decrementar}>
            ...
            <Button className={`
                flex justify-center items-center bg-cyan-600
                text-white cursor-pointer p-1
            `} color="cyan" onClick={incrementar}>
